...
export function HeroTerminal({ compact = false }: HeroTerminalProps) {
  ...
  return (
    <motion.div
      className={cn(
        "glow-border glass relative w-full rounded-2xl pb-3 pr-3",
    ...
    >
      <div className="relative overflow-hidden rounded-2xl">
        ...
        <pre
          className={cn(
            "relative overflow-x-auto p-3 pb-10 font-mono leading-relaxed sm:p-5 sm:pb-11",
      ...
      <motion.div
        className="absolute -right-1 -bottom-1 z-10 rounded-lg border border-brand-accent/30 bg-brand-accent/10 px-2 py-1 font-mono text-[10px] whitespace-nowrap text-brand-accent backdrop-blur-sm sm:-right-2 sm:-bottom-2 sm:rounded-xl sm:px-3 sm:py-2 sm:text-xs"
